return {
	...
	config = function()
		...
		vim.api.nvim_set_hl(0, "NavicIconsEnum", { fg = colors.yellow, bg = "NONE" })
		...
		vim.api.nvim_set_hl(0, "NavicIconsBoolean", { fg = colors.red, bg = "NONE" })
		vim.api.nvim_set_hl(0, "NavicIconsArray", { fg = colors.yellow, bg = "NONE" })
		...
		vim.api.nvim_set_hl(0, "NavicIconsBoolean", { fg = colors.peach, bg = "NONE" })
		vim.api.nvim_set_hl(0, "NavicIconsArray", { fg = colors.lavender, bg = "NONE" })
		vim.api.nvim_set_hl(0, "NavicIconsEnum", { fg = colors.teal, bg = "NONE" })
		vim.api.nvim_set_hl(0, "NavicIconsEnumMember", { fg = colors.mauve, bg = "NONE" })
		vim.api.nvim_set_hl(0, "NavicIconsInterface", { fg = colors.peach, bg = "NONE" })
		vim.api.nvim_set_hl(0, "NavicIconsConstant", { fg = colors.peach, bg = "NONE" })
		vim.api.nvim_set_hl(0, "NavicIconsEnumMember", { fg = colors.red, bg = "NONE" })
		vim.api.nvim_set_hl(0, "NavicIconsStruct", { fg = colors.yellow, bg = "NONE" })
		vim.api.nvim_set_hl(0, "NavicIconsEvent", { fg = colors.teal, bg = "NONE" })
		vim.api.nvim_set_hl(0, "NavicIconsOperator", { fg = colors.lavender, bg = "NONE" })
		vim.api.nvim_set_hl(0, "NavicText", { fg = colors.text, bg = "NONE" })
		vim.api.nvim_set_hl(0, "NavicSeparator", { fg = colors.overlay1, bg = "NONE" })
